...
public class AdminLoanDTO {
    @Schema(description = "The loan's id", example = "e428d134-616f-41ae-b060-4284319a74ed")
    private UUID id;
    ...
    @Schema(description = "The ID of the user who loaned the book", example = "9fe3ca19-94ee-4814-ad93-f373cee25aa1")
    private UUID userId;
